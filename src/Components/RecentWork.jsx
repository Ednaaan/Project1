    ...
    <div className='bg-black py-12 md:py-24 px-4 overflow-hidden'>
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='text-center mt-12 md:mt-16'>
          ...
          }} className='group relative w-full md:w-auto px-12 py-5 bg-transparent border border-white/20 rounded-full overflow-hidden transition-all active:scale-95'>
